    ...
    <main className="min-h-screen bg-[#0b0c10] text-slate-100">
      <div className="mx-auto max-w-3xl px-4 py-10 md:py-14">
        ...
        <div className="mt-12 border-t border-slate-800 pt-8">
          <h2 className="mb-4 text-lg font-bold text-[#e8eaf0]">Jetzt ausprobieren</h2>
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              {
                icon: '⚡',
                title: 'GiroCode Generator',
                desc: 'GiroCode kostenlos erstellen – lokal im Browser.',
                cta: 'Zum Generator →',
                href: '/',
              },
              {
                ...
                desc: 'Bestehenden GiroCode scannen und Daten auslesen.',
                cta: 'Zum Scanner →',
                href: '/scanner',
              },
              {
                ...
                desc: 'Mehrere GiroCodes auf einmal per CSV-Upload erstellen.',
