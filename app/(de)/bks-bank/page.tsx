...
const faqItems = [
  {
    question: 'Wie nutze ich den QR-Scanner in der BKS Mobile Banking App?',
    answer:
      'Öffne die BKS Mobile Banking App und navigiere zum Überweisungsbereich. Tippe auf das QR-Code-Symbol, um den Scanner zu starten, und richte die Kamera auf den GiroCode.',
  },
  {
    question: 'Was ist die BKS Bank?',
    answer:
      'Die BKS Bank AG ist ein österreichisches Kreditinstitut mit Sitz in Klagenfurt. Sie gehört zur 3 Banken Gruppe (zusammen mit Oberbank und Bank für Tirol und Vorarlberg) und ist in Österreich, Deutschland, Slowenien und Kroatien tätig.',
  },
  {
    question: 'Unterstützt BKS Bank den deutschen GiroCode-Standard?',
    answer:
      'Ja, BKS Mobile Banking unterstützt den EPC-konformen SEPA-QR-Code-Standard. Du kannst auch GiroCodes aus Deutschland problemlos mit der BKS App scannen.',
  },
  {
    question: 'Was tun, wenn der Scan fehlschlägt?',
    answer:
      'Stelle sicher, dass die BKS Mobile Banking App aktuell ist. Erhöhe die Bildschirmhelligkeit und halte die Kamera ca. 15–30 cm vom Code entfernt. Sorge für gute Beleuchtung.',
  },
];
...
export default function BksBankPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Kompatibel mit BKS Mobile Banking
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              GiroCode mit der BKS Bank App scannen
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              So nutzt du GiroCodes (SEPA-QR-Codes) mit BKS Mobile Banking –
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="anleitung">
              ...
              <ol>
                <li>
                  <strong>BKS Mobile Banking App öffnen</strong> und mit PIN oder biometrischen Daten anmelden.
                </li>
                <li>
            ...
            <section aria-labelledby="erstellen" className="mt-10">
              ...
              <p>
                Erstelle kostenlos einen EPC-konformen SEPA-QR-Code – kompatibel mit der BKS Bank App
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">Häufige Fragen – GiroCode mit BKS Bank</h2>
