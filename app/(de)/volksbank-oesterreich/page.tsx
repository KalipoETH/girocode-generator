...
const faqItems = [
  {
    question: 'Wie nutze ich den QR-Scanner in der VB-Banking App?',
    answer:
      'Öffne die VB-Banking App der Volksbank Österreich und navigiere zu „Überweisen". Im Überweisungsdialog findest du ein QR-Code-Symbol, mit dem du den Scanner aktivierst.',
  },
  {
    question: 'Was ist der Unterschied zwischen VB-Banking (Österreich) und VR-Banking (Deutschland)?',
    answer:
      'Die Volksbanken in Österreich und Deutschland sind eigenständige Unternehmen. In Österreich heißt die App VB-Banking, in Deutschland VR-Banking. Beide unterstützen GiroCodes nach dem EPC-Standard.',
  },
  {
    question: 'Können österreichische Volksbank-Kunden deutsche GiroCodes scannen?',
    answer:
      'Ja, GiroCodes sind nach dem EPC-Standard international kompatibel. Du kannst mit der VB-Banking App auch GiroCodes scannen, die in Deutschland erstellt wurden.',
  },
  {
    question: 'Was tun, wenn der Scan nicht klappt?',
    answer:
      'Stelle sicher, dass die VB-Banking App aktuell ist. Erhöhe die Bildschirmhelligkeit und halte die Kamera ca. 15–30 cm vom Code entfernt. Sorge für gute Beleuchtung.',
  },
];
...
export default function VolksbankOesterreichPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <nav aria-label="Breadcrumb" className="mb-6 text-xs text-slate-500">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden>›</li>
              <li className="text-slate-400">Volksbank Österreich</li>
            </ol>
          </nav>
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Kompatibel mit VB-Banking
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              GiroCode mit der VB-Banking App scannen
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              So nutzt du GiroCodes (SEPA-QR-Codes) mit der VB-Banking App der Volksbank Österreich –
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="anleitung">
              ...
              <ol>
                <li>
                  <strong>VB-Banking App öffnen</strong> und mit PIN oder biometrischen Daten anmelden.
                </li>
                <li>
                  <strong>„Überweisen"</strong> im Hauptmenü antippen.
                </li>
                <li>
                  <strong>QR-Code-Symbol</strong> im Überweisungsdialog antippen.
                  Kamera-Berechtigung erteilen, falls noch nicht vorhanden.
                </li>
                <li>
                ...
                <li>
                  ...
                  auf Richtigkeit kontrollieren. Nie blind bestätigen!
                </li>
                <li>
            ...
            <section aria-labelledby="erstellen" className="mt-10">
              ...
              <p>
                Erstelle kostenlos einen EPC-konformen SEPA-QR-Code – kompatibel mit der VB-Banking App
                und allen anderen Banking-Apps in Österreich und Deutschland.
              </p>
              <div className="not-prose mt-4">
                <Link
                  href="/"
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">Häufige Fragen – GiroCode mit Volksbank Österreich</h2>
          ...
          <div className="mt-12 border-t border-slate-800 pt-8">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <Link
                ...
                className="group flex items-center justify-between rounded-xl border border-[#1f2431] bg-[#121318] px-4 py-3 text-sm font-medium text-[#9aa1b6] transition-all duration-200 hover:bg-[#1a1d25] hover:border-emerald-500/25 hover:text-[#e8eaf0] sm:col-span-2"
              >
                <span>Stuzza-QR – der QR-Zahlungsstandard in Österreich</span>
                <span className="ml-2 text-[#22c55e] transition-transform duration-200 group-hover:translate-x-1">→</span>
              </Link>
            </div>
          </div>
