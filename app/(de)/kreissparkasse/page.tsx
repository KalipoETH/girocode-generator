...
const otherBanks = [
  ...
  { href: '/ostsaechsische-sparkasse', label: 'Ostsächsische Sparkasse' },
  { href: '/volksbank', label: 'Volksbank / VR-Banking' },
  { href: '/volksbank-raiffeisenbank', label: 'Volksbank Raiffeisenbank' },
  { href: '/ing', label: 'ING' },
];

const faqItems = [
  {
    question: 'Gilt diese Anleitung für alle Kreissparkassen?',
    answer:
      'Ja, alle Kreissparkassen in Deutschland nutzen die einheitliche Sparkassen-App der Sparkassen-Finanzgruppe. Der Weg zum GiroCode-Scanner ist überall identisch.',
  },
  {
    question: 'Wo finde ich den QR-Scanner in der Kreissparkasse App?',
    answer:
      'Den QR-Scanner findest du unter „Überweisungen" – oben rechts als Kamera-Symbol. Tippe darauf, um den Scanner zu starten.',
  },
  {
    question: 'Was ist der Unterschied zwischen Kreissparkasse und Stadtsparkasse?',
    answer:
      'Kreissparkassen sind dem Landkreis zugeordnet, Stadtsparkassen der kreisfreien Stadt. Beide nutzen dieselbe Sparkassen-App und haben identische GiroCode-Scanner-Funktionalität.',
  },
  {
    question: 'Unterstützt die Kreissparkasse alle GiroCodes?',
    answer:
      'Ja, die Kreissparkassen nutzen die standardisierte Sparkassen-App, die alle EPC-konformen GiroCodes (SEPA-QR-Codes) erkennt.',
  },
];
...
export default function KreissparkassePage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              GiroCode mit der Kreissparkasse scannen
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              So nutzt du GiroCodes (SEPA-QR-Codes) mit der Sparkassen-App deiner Kreissparkasse –
              Schritt für Schritt erklärt. Gilt für alle regionalen Kreissparkassen in Deutschland.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="anleitung">
              ...
              <p>
                Alle Kreissparkassen nutzen die einheitliche Sparkassen-App. So scannst du einen
                GiroCode:
              </p>
              <ol>
                <li>
            ...
            <section aria-labelledby="erstellen" className="mt-10">
              ...
              <p>
                ...
                Kreissparkassen-App und allen anderen deutschen Banking-Apps.
              </p>
              <div className="not-prose mt-4">
                <Link
                  href="/"
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">Häufige Fragen – GiroCode mit Kreissparkasse</h2>
