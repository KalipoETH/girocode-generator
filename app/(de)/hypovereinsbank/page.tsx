...
const otherBanks = [
  ...
  { href: '/ing', label: 'ING' },
  { href: '/dkb', label: 'DKB' },
  { href: '/bank-austria', label: 'Bank Austria (UniCredit AT)' },
...
const faqItems = [
  {
    question: 'Wo finde ich den QR-Scanner in der HVB MobileBanking App?',
    answer:
      'In der HVB MobileBanking App findest du den QR-Scanner im Überweisungsbereich. Tippe auf „Überweisen" und wähle die QR-Code-Option oder das Kamera-Symbol.',
  },
  {
    question: 'Was ist die HypoVereinsbank?',
    answer:
      'Die HypoVereinsbank (HVB) ist eine deutsche Großbank mit Sitz in München und gehört zur UniCredit Group. Sie ist die drittgrößte Bank in Deutschland nach Bilanzsumme.',
  },
  {
    question: 'Unterstützt die HVB App alle GiroCodes?',
    answer:
      'Ja, die HVB MobileBanking App unterstützt den EPC-konformen SEPA-QR-Code-Standard (GiroCode). Stelle sicher, dass du die aktuellste App-Version verwendest.',
  },
  {
    question: 'Gibt es einen Zusammenhang zwischen HypoVereinsbank und Bank Austria?',
    answer:
      'Ja, sowohl HypoVereinsbank als auch Bank Austria gehören zur UniCredit Group. Sie sind jedoch eigenständige Institute mit separaten Apps (HVB MobileBanking bzw. Bank Austria App).',
  },
];
...
export default function HypovereinsPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <nav aria-label="Breadcrumb" className="mb-6 text-xs text-slate-500">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden>›</li>
              <li className="text-slate-400">HypoVereinsbank</li>
            </ol>
          </nav>
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Kompatibel mit HVB MobileBanking
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              GiroCode mit der HypoVereinsbank App scannen
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              So nutzt du GiroCodes (SEPA-QR-Codes) mit der HVB MobileBanking App der HypoVereinsbank
              (UniCredit) – Schritt für Schritt erklärt.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="anleitung">
              ...
              <ol>
                <li>
                  <strong>HVB MobileBanking App öffnen</strong> und mit PIN oder biometrischen
                  Daten anmelden.
                </li>
                <li>
                ...
                <li>
                  <strong>Überweisung bestätigen</strong> mit HVB Mobile TAN oder biometrischer
                  Freigabe.
                </li>
              </ol>
            </section>
            ...
            <section aria-labelledby="erstellen" className="mt-10">
              ...
              <p>
                Erstelle kostenlos einen EPC-konformen SEPA-QR-Code – kompatibel mit der HVB
                MobileBanking App und allen anderen deutschen Banking-Apps.
              </p>
              <div className="not-prose mt-4">
                <Link
                  href="/"
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">Häufige Fragen – GiroCode mit HypoVereinsbank</h2>
