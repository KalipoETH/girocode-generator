...
const faqItems = [
  {
    question: 'Welche Hypo-Banken gibt es in Österreich?',
    answer:
      'Die wichtigsten Hypo-Banken in Österreich sind Hypo Tirol Bank, Hypo Vorarlberg Bank und Hypo NÖ (Niederösterreich). Alle bieten eine eigene Mobile-Banking-App mit integriertem GiroCode-Scanner.',
  },
  {
    question: 'Wo finde ich den QR-Scanner in der Hypo Banking App?',
    answer:
      'In der Hypo Banking App findest du den QR-Scanner im Überweisungsbereich. Wähle „Überweisen" und tippe auf das QR-Code-Symbol, um den Scanner zu aktivieren.',
  },
  {
    question: 'Unterstützen alle Hypo-Apps den GiroCode-Standard?',
    answer:
      'Ja, die Apps der österreichischen Hypo-Banken unterstützen den EPC-konformen SEPA-QR-Code-Standard (GiroCode). Stelle sicher, dass die App auf dem neuesten Stand ist.',
  },
  {
    question: 'Kann ich mit der Hypo Banking App auch deutsche GiroCodes scannen?',
    answer:
      'Ja, der EPC-Standard ist international. Du kannst mit der Hypo Banking App problemlos GiroCodes scannen, die mit deutschen oder anderen europäischen SEPA-Tools erstellt wurden.',
  },
];
...
export default function HypoOesterreichPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <nav aria-label="Breadcrumb" className="mb-6 text-xs text-slate-500">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden>›</li>
              <li className="text-slate-400">Hypo Österreich</li>
            </ol>
          </nav>
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Kompatibel mit Hypo Banking App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              GiroCode mit der Hypo Banking App scannen
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              So nutzt du GiroCodes (SEPA-QR-Codes) mit der Hypo Banking App in Österreich
              (Hypo Tirol, Hypo Vorarlberg, Hypo NÖ) – Schritt für Schritt erklärt.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="anleitung">
              ...
              <ol>
                <li>
                  <strong>Hypo Banking App öffnen</strong> und mit PIN oder biometrischen Daten anmelden.
                </li>
                <li>
                  <strong>„Überweisen"</strong> im Hauptmenü antippen.
                </li>
                <li>
                  <strong>QR-Code-Symbol</strong> im Überweisungsdialog antippen und
              ...
              <p>
                <strong>Hinweis:</strong> Die Apps von Hypo Tirol, Hypo Vorarlberg und Hypo NÖ
                sind eigenständige Anwendungen, aber der Weg zum GiroCode-Scanner ist in allen
                sehr ähnlich.
              </p>
            </section>
            ...
            <section aria-labelledby="erstellen" className="mt-10">
              ...
              <p>
                ...
                österreichischen Hypo-Banking-Apps und deutschen Banking-Apps.
              </p>
              <div className="not-prose mt-4">
                <Link
                  href="/"
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">Häufige Fragen – GiroCode mit Hypo Österreich</h2>
