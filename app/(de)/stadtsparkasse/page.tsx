...
const faqItems = [
  {
    question: 'Gilt diese Anleitung für alle Stadtsparkassen?',
    answer:
      'Ja, alle Stadtsparkassen in Deutschland nutzen die einheitliche Sparkassen-App der Sparkassen-Finanzgruppe. Der Weg zum GiroCode-Scanner ist überall identisch.',
  },
  {
    question: 'Was ist der Unterschied zwischen Stadtsparkasse und Kreissparkasse?',
    answer:
      'Stadtsparkassen sind kreisfreien Städten zugeordnet, Kreissparkassen dem Landkreis. Beide nutzen dieselbe Sparkassen-App und unterstützen GiroCodes vollständig.',
  },
  {
    question: 'Wo finde ich den QR-Scanner in der Stadtsparkasse App?',
    answer:
      'Den QR-Scanner findest du unter „Überweisungen" – oben rechts als Kamera-Symbol. Tippe darauf, um direkt zur Scanner-Ansicht zu wechseln.',
  },
  {
    question: 'Welche Stadtsparkassen gibt es?',
    answer:
      'In Deutschland gibt es viele Stadtsparkassen, darunter Stadtsparkasse München, Stadtsparkasse Düsseldorf, Stadtsparkasse Wuppertal und weitere. Alle nutzen die einheitliche Sparkassen-App.',
  },
];
...
export default function StadtsparkassePage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              GiroCode mit der Stadtsparkasse scannen
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              So nutzt du GiroCodes (SEPA-QR-Codes) mit der Sparkassen-App deiner Stadtsparkasse –
              Schritt für Schritt erklärt. Gilt für alle Stadtsparkassen in Deutschland.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="erstellen" className="mt-10">
              ...
              <p>
                ...
                Stadtsparkassen-App und allen anderen deutschen Banking-Apps.
              </p>
              <div className="not-prose mt-4">
                <Link
                  href="/"
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">Häufige Fragen – GiroCode mit Stadtsparkasse</h2>
