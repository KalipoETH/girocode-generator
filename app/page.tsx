  ...
  return (
    <main className="min-h-screen bg-[#0b0c10] text-slate-100">
      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-10 px-4 pb-12">
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-400 sm:text-base">
                  Gestalte deine Rechnung individuell – Drag &amp; Drop, eigenes Logo, freie Gestaltung.
                  Komplett kostenlos &amp; lokal im Browser.
                </p>
              </div>
        ...
        {/* Use-Cases */}
        <section aria-labelledby="usecases-section-de" className="animate-card-in mt-8 space-y-4" style={{ animationDelay: '1.25s' }}>
          <div className="space-y-1">
            <h2 id="usecases-section-de" className="text-base font-semibold tracking-tight text-slate-50 md:text-lg">
              GiroCode für jeden Anwendungsfall
            </h2>
            <p className="text-sm text-[#8b90a0]">Ratgeber & Praxistipps für deine Zielgruppe</p>
          </div>
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { icon: '👨‍💻', title: 'Freelancer', desc: 'Schneller bezahlt werden – ohne IBAN-Tippfehler.', href: '/freelancer' },
              { icon: '🏛️', title: 'Vereine', desc: 'Mitgliedsbeiträge & Spenden einfach einziehen.', href: '/verein' },
              { icon: '🔧', title: 'Handwerker', desc: 'Rechnungen, die direkt vor Ort bezahlt werden.', href: '/handwerker' },
              { icon: '💝', title: 'Spenden', desc: 'Mehr Spenden durch einfaches Scannen.', href: '/spenden' },
              { icon: '🏢', title: 'Kleinunternehmen', desc: 'Pflichtkonforme PDF-Rechnungen ohne Abo.', href: '/kleinunternehmen' },
              { icon: '🛒', title: 'Privatverkauf', desc: 'eBay Kleinanzeigen & Co. ohne Gebühren.', href: '/privatverkauf' },
            ].map((useCase) => (
              <Link
                key={useCase.href}
                href={useCase.href}
        ...
        <section aria-labelledby="also-interesting-de" className="animate-card-in mt-8 space-y-4" style={{ animationDelay: '1.28s' }}>
          <h2 id="also-interesting-de" className="text-base font-semibold tracking-tight text-slate-50 md:text-lg">
            Das könnte dich auch interessieren
          </h2>
            ...
            {[
              {
                ...
                desc: 'Scanne einen bestehenden GiroCode und lese die Zahlungsdaten aus.',
                cta: 'Zum Scanner →',
                href: '/scanner',
              },
              {
                ...
                desc: 'Erstelle mehrere GiroCodes auf einmal per CSV-Upload.',
                cta: 'Zum Bulk Generator →',
                href: '/bulk',
              },
              {
                icon: '🏦',
                title: 'Banking-App Anleitung',
                desc: 'Welche Banking-Apps unterstützen GiroCodes?',
                cta: 'Apps anzeigen →',
                href: '/wissen/banking-apps',
              },
              {
        ...
        {/* Vergleichstabelle */}
        <section aria-labelledby="vergleich-section-de" className="animate-card-in mt-8 space-y-4" style={{ animationDelay: '1.29s' }}>
          <h2 id="vergleich-section-de" className="text-base font-semibold tracking-tight text-slate-50 md:text-lg">
            ...
            <table className="w-full text-sm text-left">
              <thead>
                <tr className="border-b border-[#1f2431] bg-[#0f1117]">
                  ...
                  <th className="px-4 py-3 font-semibold text-slate-300">Klassische Überweisung</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#1f2431] bg-[#121318]">
                {[
                  ['Kosten', 'Kostenlos', '1,2–3,4 % Gebühren', 'Kostenlos'],
                  ['Geschwindigkeit', 'Sofort scannen (10 Sek.)', 'Sofort', '1–2 Werktage'],
                  ['Datenschutz', 'DSGVO, lokal', 'US-Server', 'DSGVO'],
                  ['Banking-App nötig', 'Ja', 'Nein', 'Ja'],
                  ['Fehler möglich', 'Nein (autom.)', 'Selten', 'Ja (Tippfehler)'],
