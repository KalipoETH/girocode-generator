...
export const metadata: Metadata = {
  title: 'GiroCode con Volksbank – Guía paso a paso 2026',
  description:
    'Escanear un GiroCode con Volksbank: Abrir escáner QR en la app VR Banking App, escanear el código, confirmar la transferencia. ✅ Guía paso a paso 2026.',
  keywords: 'girocode volksbank, volksbank girocode scan, volksbank qr code, sepa qr volksbank',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/es/volksbank',
    languages: {
...
export default function VolksbankEsPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Escanear GiroCode con Volksbank
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Cómo usar GiroCodes (códigos QR SEPA) con Volksbank – paso a paso. Listo en menos de 30 segundos.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>La app VR Banking App de Volksbank tiene un escáner GiroCode integrado. Así se usa:</p>
              <ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode con Volksbank</h2>
