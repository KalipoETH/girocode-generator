...
export const metadata: Metadata = {
  title: 'GiroCode con Erste Bank – Guía paso a paso 2026',
  description:
    'Escanear un GiroCode con Erste Bank: Abrir escáner QR en la app George App, escanear el código, confirmar la transferencia. ✅ Guía paso a paso 2026.',
  keywords: 'girocode erste-bank, erste-bank girocode scan, erste-bank qr code, sepa qr erste-bank',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/es/erste-bank',
    languages: {
...
const faqItems = [
  {
    question: '¿La app George App soporta todos los GiroCodes?',
    answer:
      'Sí, la app George App reconoce todos los códigos QR SEPA conformes EPC (GiroCodes). Asegúrate de tener la app actualizada. Comprueba la App Store o Google Play.',
  },
  {
    question: '¿Dónde encuentro el escáner QR en la app George App?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Sí. Siempre ves todos los datos de la transferencia antes de confirmar. La confirmación requiere George TAN o biometría. El código en sí no contiene datos sensibles que puedan ser mal utilizados.',
  },
];
...
export default function ErsteBankEsPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible con George App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Escanear GiroCode con Erste Bank
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Cómo usar GiroCodes (códigos QR SEPA) con Erste Bank – paso a paso. Listo en menos de 30 segundos.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>La app George App de Erste Bank tiene un escáner GiroCode integrado. Así se usa:</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Abrir la app George App</strong> e iniciar sesión con PIN, huella digital o Face ID.' }} />
                ...
                <li dangerouslySetInnerHTML={{ __html: '<strong>Confirmar la transferencia</strong> con George TAN o biometría. Listo.' }} />
              </ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode con Erste Bank</h2>
