...
export const metadata: Metadata = {
  title: 'Apps bancarias compatibles con GiroCode 2026 – Lista completa',
  description:
    '¿Qué apps bancarias escanean GiroCodes? Sparkasse ✅ ING ✅ DKB ✅ Volksbank ✅ N26 ✅ y 8 más. Guía paso a paso para cada app.',
  alternates: {
    canonical: `${SITE_URL}/es/wissen/banking-apps`,
    languages: {
...
export default function WissenBankingAppsPageEs() {
  return (
    <KnowledgeLayout
      ...
      statsData={[
        { value: '12+', label: 'Apps bancarias alemanas compatibles' },
        { value: '30 seg.', label: 'Desde escaneo hasta confirmación' },
        { value: '2016', label: 'Soporte generalizado de apps' },
