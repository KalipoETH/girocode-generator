...
export const metadata: Metadata = {
  title: 'GiroCode con Berliner Sparkasse – Guía paso a paso 2026',
  description:
    'Escanear un GiroCode con Berliner Sparkasse: Abrir escáner QR en la app Berliner Sparkasse App, escanear el código, confirmar la transferencia. ✅ Guía paso a paso 2026.',
  ...
  alternates: {
    canonical: 'https://www.girocodegenerator.com/es/berliner-sparkasse',
    languages: {
...
const faqItems = [
  {
    question: '¿La app Berliner Sparkasse App soporta todos los GiroCodes?',
    answer:
      'Sí, la app Berliner Sparkasse App reconoce todos los códigos QR SEPA conformes EPC (GiroCodes). Asegúrate de tener la app actualizada. Comprueba la App Store o Google Play.',
  },
  {
    question: '¿Dónde encuentro el escáner QR en la app Berliner Sparkasse App?',
    answer:
...
export default function BerlinerSparkasseEsPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible con Berliner Sparkasse App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Escanear GiroCode con Berliner Sparkasse
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Cómo usar GiroCodes (códigos QR SEPA) con Berliner Sparkasse – paso a paso. Listo en menos de 30 segundos.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>La app Berliner Sparkasse App de Berliner Sparkasse tiene un escáner GiroCode integrado. Así se usa:</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Abrir la app Berliner Sparkasse App</strong> e iniciar sesión con PIN, huella digital o Face ID.' }} />
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode con Berliner Sparkasse</h2>
