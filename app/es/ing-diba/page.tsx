...
const faqItems = [
  {
    question: '¿La app ING Banking App soporta todos los GiroCodes?',
    answer:
      'Sí, la app ING Banking App reconoce todos los códigos QR SEPA conformes EPC (GiroCodes). Asegúrate de tener la app actualizada. Comprueba la App Store o Google Play.',
  },
  {
    question: '¿Dónde encuentro el escáner QR en la app ING Banking App?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Sí. Siempre ves todos los datos de la transferencia antes de confirmar. La confirmación requiere ING-TAN o biometría. El código en sí no contiene datos sensibles que puedan ser mal utilizados.',
  },
];
...
export default function IngDibaEsPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible con ING Banking App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Escanear GiroCode con ING (formerly ING-DiBa)
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Cómo usar GiroCodes (códigos QR SEPA) con ING (formerly ING-DiBa) – paso a paso. Listo en menos de 30 segundos.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>La app ING Banking App de ING (formerly ING-DiBa) tiene un escáner GiroCode integrado. Así se usa:</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Abrir la app ING Banking App</strong> e iniciar sesión con PIN, huella digital o Face ID.' }} />
                ...
                <li dangerouslySetInnerHTML={{ __html: '<strong>Confirmar la transferencia</strong> con ING-TAN o biometría. Listo.' }} />
              </ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode con ING (formerly ING-DiBa)</h2>
