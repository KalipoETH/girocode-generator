...
export const metadata: Metadata = {
  title: 'IBAN & BIC dans GiroCode – Format, Obligatoire & Validation',
  description:
    'IBAN et BIC pour GiroCode: Le BIC est-il obligatoire? Comment fonctionne la validation IBAN (Mod-97)? Tous les formats expliqués.',
  alternates: {
    canonical: `${SITE_URL}/fr/wissen/iban-bic`,
    languages: {
...
export default function WissenIbanBicPageFr() {
  return (
    <KnowledgeLayout
      ...
      lead="L'IBAN (International Bank Account Number) est un numéro de compte international de 34 caractères maximum selon la norme ISO 13616. Les IBAN allemands ont exactement 22 caractères. Le BIC est optionnel pour les GiroCodes depuis la migration SEPA en 2016."
      relatedArticles={[
      ...
      statsData={[
        ...
        { value: '34', label: "Nb max. de chiffres d'un IBAN mondial" },
        { value: '2016', label: 'BIC est devenu facultatif (migration SEPA)' },
        { value: '97', label: 'Modulo clé de contrôle (algorithme Mod-97)' },
      ]}
    >
