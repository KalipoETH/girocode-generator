...
export const metadata: Metadata = {
  title: 'Norme EPC expliquée – Structure du code QR SEPA 2026',
  description:
    'La norme EPC pour GiroCodes: structure du payload ligne par ligne, versions 001/002, correction d\'erreurs et exemple JavaScript.',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/fr/wissen/epc-standard',
    languages: {
...
export default function WissenEpcStandardPageFr() {
  return (
    <KnowledgeLayout
      ...
      lead="La norme EPC (document EPC069-12) définit la structure technique des codes QR SEPA. Un payload EPC valide comprend 11 lignes: Service Tag (BCD), Version, encodage UTF-8, Identification (SCT), BIC optionnel, nom du bénéficiaire (max. 70 caractères), IBAN, montant au format EUR49.90, et référence de paiement (max. 140 caractères)."
      relatedArticles={[
      ...
      statsData={[
        ...
        { value: '70', label: 'Nb max. de caractères nom bénéficiaire' },
        { value: '140', label: 'Nb max. de caractères référence paiement' },
        { value: '15%', label: 'Niveau de correction erreur M' },
      ]}
    >
