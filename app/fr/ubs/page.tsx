...
export const metadata: Metadata = {
  title: 'GiroCode avec UBS – Guide étape par étape 2026',
  description:
    'Scanner un GiroCode avec UBS: Ouvrir le scanner QR dans l\'app UBS Mobile Banking App, scanner le code, confirmer le virement. ✅ Guide étape par étape 2026.',
  keywords: 'girocode ubs, ubs girocode scan, ubs qr code, sepa qr ubs',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/fr/ubs',
    languages: {
...
export default function UbsFrPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            ...
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scanner un GiroCode avec UBS
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Comment utiliser les GiroCodes (codes QR SEPA) avec UBS – étape par étape. Terminé en moins de 30 secondes.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>L'app UBS Mobile Banking App de UBS dispose d'un scanner GiroCode intégré. Voici comment l'utiliser :</p>
              <ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode avec UBS</h2>
