...
export const metadata: Metadata = {
  title: 'GiroCode avec DKB – Guide étape par étape 2026',
  description:
    'Scanner un GiroCode avec DKB: Ouvrir le scanner QR dans l\'app DKB Banking App, scanner le code, confirmer le virement. ✅ Guide étape par étape 2026.',
  keywords: 'girocode dkb, dkb girocode scan, dkb qr code, sepa qr dkb',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/fr/dkb',
    languages: {
...
const faqItems = [
  {
    question: 'L\'app DKB Banking App supporte-t-elle tous les GiroCodes ?',
    answer:
      'Oui, l\'app DKB Banking App reconnaît tous les codes QR SEPA conformes EPC (GiroCodes). Assurez-vous que l\'app est à jour. Vérifiez l\'App Store ou Google Play pour les mises à jour.',
  },
  {
    question: 'Où trouver le scanner QR dans l\'app DKB Banking App ?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Oui. Vous voyez toujours toutes les données de virement avant de confirmer. La confirmation nécessite DKB-TAN2 ou biométrie. Le code lui-même ne contient aucune donnée sensible qui pourrait être détournée.',
  },
];
...
export default function DkbFrPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible avec DKB Banking App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scanner un GiroCode avec DKB
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Comment utiliser les GiroCodes (codes QR SEPA) avec DKB – étape par étape. Terminé en moins de 30 secondes.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>L'app DKB Banking App de DKB dispose d'un scanner GiroCode intégré. Voici comment l'utiliser :</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Ouvrir l\'app DKB Banking App</strong> et se connecter avec PIN, empreinte digitale ou Face ID.' }} />
                ...
                <li dangerouslySetInnerHTML={{ __html: '<strong>Confirmer le virement</strong> avec DKB-TAN2 ou biométrie. Terminé.' }} />
              </ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode avec DKB</h2>
