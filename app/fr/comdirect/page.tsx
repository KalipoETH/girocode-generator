...
export const metadata: Metadata = {
  title: 'GiroCode avec Comdirect – Guide étape par étape 2026',
  description:
    'Scanner un GiroCode avec Comdirect: Ouvrir le scanner QR dans l\'app Comdirect Banking App, scanner le code, confirmer le virement. ✅ Guide étape par étape 2026.',
  keywords: 'girocode comdirect, comdirect girocode scan, comdirect qr code, sepa qr comdirect',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/fr/comdirect',
    languages: {
...
const faqItems = [
  {
    question: 'L\'app Comdirect Banking App supporte-t-elle tous les GiroCodes ?',
    answer:
      'Oui, l\'app Comdirect Banking App reconnaît tous les codes QR SEPA conformes EPC (GiroCodes). Assurez-vous que l\'app est à jour. Vérifiez l\'App Store ou Google Play pour les mises à jour.',
  },
  {
    question: 'Où trouver le scanner QR dans l\'app Comdirect Banking App ?',
    answer:
...
export default function ComdirectFrPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible avec Comdirect Banking App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scanner un GiroCode avec Comdirect
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Comment utiliser les GiroCodes (codes QR SEPA) avec Comdirect – étape par étape. Terminé en moins de 30 secondes.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>L'app Comdirect Banking App de Comdirect dispose d'un scanner GiroCode intégré. Voici comment l'utiliser :</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Ouvrir l\'app Comdirect Banking App</strong> et se connecter avec PIN, empreinte digitale ou Face ID.' }} />
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode avec Comdirect</h2>
