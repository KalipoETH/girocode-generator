...
export const metadata: Metadata = {
  title: 'GiroCode avec Hamburger Sparkasse – Guide étape par étape 2026',
  description:
    'Scanner un GiroCode avec Hamburger Sparkasse: Ouvrir le scanner QR dans l\'app Haspa App, scanner le code, confirmer le virement. ✅ Guide étape par étape 2026.',
  ...
  alternates: {
    canonical: 'https://www.girocodegenerator.com/fr/hamburger-sparkasse',
    languages: {
...
const faqItems = [
  {
    question: 'L\'app Haspa App supporte-t-elle tous les GiroCodes ?',
    answer:
      'Oui, l\'app Haspa App reconnaît tous les codes QR SEPA conformes EPC (GiroCodes). Assurez-vous que l\'app est à jour. Vérifiez l\'App Store ou Google Play pour les mises à jour.',
  },
  {
    question: 'Où trouver le scanner QR dans l\'app Haspa App ?',
    answer:
...
export default function HamburgerSparkasseFrPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <nav aria-label="Breadcrumb" className="mb-6 text-xs text-slate-500">
            <ol className="flex flex-wrap items-center gap-x-2 gap-y-1">
              ...
              <li aria-hidden>›</li>
              <li className="text-slate-400">Hamburger Sparkasse</li>
            </ol>
          </nav>
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible avec Haspa App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scanner un GiroCode avec Hamburger Sparkasse
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Comment utiliser les GiroCodes (codes QR SEPA) avec Hamburger Sparkasse – étape par étape. Terminé en moins de 30 secondes.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>L'app Haspa App de Hamburger Sparkasse dispose d'un scanner GiroCode intégré. Voici comment l'utiliser :</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Ouvrir l\'app Haspa App</strong> et se connecter avec PIN, empreinte digitale ou Face ID.' }} />
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode avec Hamburger Sparkasse</h2>
