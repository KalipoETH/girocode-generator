...
const faqItems = [
  {
    question: 'L\'app Kreissparkasse App supporte-t-elle tous les GiroCodes ?',
    answer:
      'Oui, l\'app Kreissparkasse App reconnaît tous les codes QR SEPA conformes EPC (GiroCodes). Assurez-vous que l\'app est à jour. Vérifiez l\'App Store ou Google Play pour les mises à jour.',
  },
  {
    question: 'Où trouver le scanner QR dans l\'app Kreissparkasse App ?',
    answer:
...
export default function KreissparkasseFrPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible avec Kreissparkasse App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scanner un GiroCode avec Kreissparkasse
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              Comment utiliser les GiroCodes (codes QR SEPA) avec Kreissparkasse – étape par étape. Terminé en moins de 30 secondes.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>L'app Kreissparkasse App de Kreissparkasse dispose d'un scanner GiroCode intégré. Voici comment l'utiliser :</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Ouvrir l\'app Kreissparkasse App</strong> et se connecter avec PIN, empreinte digitale ou Face ID.' }} />
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode avec Kreissparkasse</h2>
