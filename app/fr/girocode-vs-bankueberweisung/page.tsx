...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.girocodegenerator.com/fr/girocode-vs-bankueberweisung',
    languages: {
...
const jsonLd = {
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.girocodegenerator.com/fr/girocode-vs-bankueberweisung' },
};
