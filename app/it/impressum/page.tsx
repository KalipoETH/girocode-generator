  ...
  return (
    <main className="min-h-screen bg-[#0b0c10] text-slate-100">
      <div className="mx-auto max-w-3xl px-4 py-10">
        <h1 className="mb-4 text-2xl font-semibold tracking-tight text-slate-50">Impressum</h1>
        <p className="mb-6 text-sm text-slate-400">
          Informazioni legali secondo § 5 DDG (Germania)
        </p>
        <section className="space-y-4 text-sm text-slate-300">
          <div>
            <h2 className="mb-1 text-base font-semibold text-slate-50">Dienstanbieter</h2>
            <p>
              Kaleb Jahnke
              <br />
              Koppelstraße 6a
          ...
          <div>
            <h2 className="mb-1 text-base font-semibold text-slate-50">Kontakt</h2>
            <p>
              E-Mail:{' '}
              <a
          ...
          <div>
            <h2 className="mb-1 text-base font-semibold text-slate-50">Haftung für Inhalte</h2>
            <p>
          ...
          <div>
            <h2 className="mb-1 text-base font-semibold text-slate-50">Haftung für Links</h2>
            <p>
          ...
          <div>
            <h2 className="mb-1 text-base font-semibold text-slate-50">Urheberrecht</h2>
            <p>
