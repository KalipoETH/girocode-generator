...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.girocodegenerator.com/en/girocode-vs-lastschrift',
    languages: {
...
const jsonLd = {
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://www.girocodegenerator.com/en/girocode-vs-lastschrift' },
};
