...
const faqItems = [
  {
    question: 'Does the Comdirect Banking App support all GiroCodes?',
    answer:
      'Yes, the Comdirect Banking App recognises all EPC-compliant SEPA QR codes (GiroCodes). Make sure the app is up to date. Check the App Store or Google Play for updates.',
  },
  {
    question: 'Where do I find the QR scanner in the Comdirect Banking App?',
    answer:
...
export default function ComdirectEnPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible with Comdirect Banking App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scan GiroCode with Comdirect
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              How to use GiroCodes (SEPA QR codes) with Comdirect – step by step. Done in less than 30 seconds.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>The Comdirect Banking App of Comdirect has a built-in GiroCode scanner. Here's how to use it:</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Open Comdirect Banking App</strong> and log in with PIN, fingerprint or Face ID.' }} />
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode with Comdirect</h2>
