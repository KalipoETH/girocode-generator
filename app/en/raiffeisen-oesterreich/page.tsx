...
export const metadata: Metadata = {
  title: 'GiroCode with Raiffeisen Österreich – Step-by-Step Guide 2026',
  description:
    'Scan a GiroCode with Raiffeisen Österreich: Open QR scanner in the Mein ELBA App, scan the code, confirm the transfer. ✅ Step-by-step guide 2026.',
  ...
  alternates: {
    canonical: 'https://www.girocodegenerator.com/en/raiffeisen-oesterreich',
    languages: {
...
const faqItems = [
  {
    question: 'Does the Mein ELBA App support all GiroCodes?',
    answer:
      'Yes, the Mein ELBA App recognises all EPC-compliant SEPA QR codes (GiroCodes). Make sure the app is up to date. Check the App Store or Google Play for updates.',
  },
  {
    question: 'Where do I find the QR scanner in the Mein ELBA App?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes. You always see all transfer data before confirming. The confirmation requires ELBA-TAN or biometrics. The code itself contains no sensitive data that could be misused.',
  },
];
...
export default function RaiffeisenOesterreichEnPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible with Mein ELBA App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scan GiroCode with Raiffeisen Österreich
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              How to use GiroCodes (SEPA QR codes) with Raiffeisen Österreich – step by step. Done in less than 30 seconds.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>The Mein ELBA App of Raiffeisen Österreich has a built-in GiroCode scanner. Here's how to use it:</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Open Mein ELBA App</strong> and log in with PIN, fingerprint or Face ID.' }} />
                ...
                <li dangerouslySetInnerHTML={{ __html: '<strong>Confirm the transfer</strong> with ELBA-TAN or biometrics. Done.' }} />
              </ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode with Raiffeisen Österreich</h2>
