...
export const metadata: Metadata = {
  title: 'GiroCode with Postbank – Step-by-Step Guide 2026',
  description:
    'Scan a GiroCode with Postbank: Open QR scanner in the Postbank Finanzassistent, scan the code, confirm the transfer. ✅ Step-by-step guide 2026.',
  keywords: 'girocode postbank, postbank girocode scan, postbank qr code, sepa qr postbank',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/en/postbank',
    languages: {
      'x-default': 'https://www.girocodegenerator.com/postbank',
      de: 'https://www.girocodegenerator.com/postbank',
      en: 'https://www.girocodegenerator.com/en/postbank',
      fr: 'https://www.girocodegenerator.com/fr/postbank',
      es: 'https://www.girocodegenerator.com/es/postbank',
    },
  },
};
...
const faqItems = [
  {
    question: 'Does the Postbank Finanzassistent support all GiroCodes?',
    answer:
      'Yes, the Postbank Finanzassistent recognises all EPC-compliant SEPA QR codes (GiroCodes). Make sure the app is up to date. Check the App Store or Google Play for updates.',
  },
  {
    question: 'Where do I find the QR scanner in the Postbank Finanzassistent?',
    answer:
      'You\'ll find the QR scanner under "Transfer" – look for the camera icon. Tap it to open the scanner view.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Yes. You always see all transfer data before confirming. The confirmation requires BestSign or TAN. The code itself contains no sensitive data that could be misused.',
  },
];
...
export default function PostbankEnPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible with Postbank Finanzassistent
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scan GiroCode with Postbank
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              How to use GiroCodes (SEPA QR codes) with Postbank – step by step. Done in less than 30 seconds.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>The Postbank Finanzassistent of Postbank has a built-in GiroCode scanner. Here's how to use it:</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Open Postbank Finanzassistent</strong> and log in with PIN, fingerprint or Face ID.' }} />
                <li dangerouslySetInnerHTML={{ __html: '<strong>Tap "Transfer"</strong> in the menu.' }} />
                ...
                <li dangerouslySetInnerHTML={{ __html: '<strong>Confirm the transfer</strong> with BestSign or TAN. Done.' }} />
              </ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode with Postbank</h2>
