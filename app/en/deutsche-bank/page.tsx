...
export const metadata: Metadata = {
  title: 'GiroCode with Deutsche Bank – Step-by-Step Guide 2026',
  description:
    'Scan a GiroCode with Deutsche Bank: Open QR scanner in the Deutsche Bank App, scan the code, confirm the transfer. ✅ Step-by-step guide 2026.',
  keywords: 'girocode deutsche-bank, deutsche-bank girocode scan, deutsche-bank qr code, sepa qr deutsche-bank',
  alternates: {
    canonical: 'https://www.girocodegenerator.com/en/deutsche-bank',
    languages: {
...
const faqItems = [
  {
    question: 'Does the Deutsche Bank App support all GiroCodes?',
    answer:
      'Yes, the Deutsche Bank App recognises all EPC-compliant SEPA QR codes (GiroCodes). Make sure the app is up to date. Check the App Store or Google Play for updates.',
  },
  {
    question: 'Where do I find the QR scanner in the Deutsche Bank App?',
    answer:
  ...
  },
  {
    ...
    answer:
      'Yes. You always see all transfer data before confirming. The confirmation requires photoTAN or pushTAN. The code itself contains no sensitive data that could be misused.',
  },
];
...
export default function DeutscheBankEnPage() {
  return (
    <>
      <script
        ...
        <div className="mx-auto max-w-3xl px-4 py-10 md:py-12">
          ...
          <header className="mb-10 space-y-4">
            <p className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 px-3 py-1 text-[11px] font-medium text-emerald-300 ring-1 ring-emerald-500/40">
              ...
              Compatible with Deutsche Bank App
            </p>
            <h1 className="text-2xl font-bold tracking-tight text-[#e8eaf0] md:text-3xl">
              Scan GiroCode with Deutsche Bank
            </h1>
            <p className="max-w-2xl text-sm leading-relaxed text-slate-400 md:text-base">
              How to use GiroCodes (SEPA QR codes) with Deutsche Bank – step by step. Done in less than 30 seconds.
            </p>
          </header>
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            ...
            <section aria-labelledby="steps">
              ...
              <p>The Deutsche Bank App of Deutsche Bank has a built-in GiroCode scanner. Here's how to use it:</p>
              <ol>
                <li dangerouslySetInnerHTML={{ __html: '<strong>Open Deutsche Bank App</strong> and log in with PIN, fingerprint or Face ID.' }} />
                ...
                <li dangerouslySetInnerHTML={{ __html: '<strong>Confirm the transfer</strong> with photoTAN or pushTAN. Done.' }} />
              </ol>
            ...
            <section aria-labelledby="faq" className="mt-10">
              <h2 id="faq">FAQ – GiroCode with Deutsche Bank</h2>
