...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/en/wissen/iban-bic`,
    languages: {
...
export default function WissenIbanBicPageEn() {
  return (
    <KnowledgeLayout
      ...
      lead="The IBAN (International Bank Account Number) is an international account number of up to 34 characters following ISO 13616 standard. German IBANs have exactly 22 characters: 2-letter country code (DE), 2 check digits, and 18 digits for bank code and account number. The BIC (Bank Identifier Code) has been optional for GiroCodes since the SEPA migration in 2016."
      relatedArticles={[
